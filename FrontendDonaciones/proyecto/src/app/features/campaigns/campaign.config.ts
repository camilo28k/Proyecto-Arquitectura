import type { CampaignCategory, CampaignCategoryConfig } from "./campaign.types";

const withIdPath = (endpoint: string) => (id: string) => `${endpoint}/id/${id}`;
const directIdPath = (endpoint: string) => (id: string) => `${endpoint}/${id}`;

export const CAMPAIGN_CATEGORIES: Record<CampaignCategory, CampaignCategoryConfig> = {
  health: {
    key: "health",
    endpoint: "/health",
    title: "Salud",
    navName: "Health",
    description: "Campañas para tratamientos, medicinas, jornadas y apoyo medico.",
    accent: "bg-rose-500",
    acceptsImage: true,
  ...
  education: {
    ...
    title: "Educación",
    navName: "Education",
    description: "Campañas para becas, utiles, conectividad y espacios de aprendizaje.",
    accent: "bg-sky-500",
    acceptsImage: false,
  ...
  technology: {
    ...
    title: "Tecnología",
    navName: "Technology",
    description: "Campañas para equipos, laboratorios, prototipos e inclusion digital.",
...
export const CAMPAIGN_ROUTE_ITEMS = [
  ...
  { path: "/entrepreneurship", name: CAMPAIGN_CATEGORIES.entrepreneurship.navName },
  { path: "/environment", name: CAMPAIGN_CATEGORIES.environment.navName },
  { path: "/universityproject", name: CAMPAIGN_CATEGORIES.universityproject.navName },
];